...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">New Travel's Package</h1>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('travel-package.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Title's Package" value="{{ old('title') }}">
                    </div>

                    <div class="form-group">
                        <label for="location">Destination</label>
                        <input type="text" class="form-control" name="location" placeholder="Destination" value="{{ old('location') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="type" placeholder="Trip's Type" value="{{ old('type') }}">
                    </div>
